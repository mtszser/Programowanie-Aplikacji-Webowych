...
function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        this.showBtn.addEventListener("click", function () {
          return _this.getCityInfo(_this.opwApiKey);
        });
        return [2
        /*return*/
        ];
  ...
  App.prototype.createElement = function (weatherData) {
    ...
    console.log(weather);
    this.cityWeatherElement(weather);
  };

  App.prototype.cityWeatherElement = function (weather) {
    var weatherDiv = document.createElement("div");
    weatherDiv.id = "weatherDiv";
    weatherDiv.className = "weatherStyle";
